...
(	-t on the Image build Command is the tag name : dockerId/repositoryname:Version 
 ...
 docker container run -d --name web98 --mount source=ubervol,target=/vol -p 8000:8080 rahuljaiswal1000/gsd:first-container // Run a  New  Container with the same  Volume  Attached
